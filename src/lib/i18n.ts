...
export const copy = {
  en: {
    ...
    home: {
      ...
      flowLead: 'Watch the capsule. The word in gold is the live step.',
      flowPartner: 'You',
      flowOps: 'Dinymeo',
      flowSync: 'In sync',
      flow: [
        { title: 'Brief', text: 'Molecule. Pack. Market.' },
        { title: 'Formulation', text: 'Stable. Testable.' },
        { title: 'QA', text: 'Specs you see.' },
        { title: 'Make', text: 'Documented batch.' },
        { title: 'Pack', text: 'Barrier chosen.' },
        { title: 'Dispatch', text: 'On the date.' },
        { title: 'Your brand', text: 'You take it out.' },
      ],
